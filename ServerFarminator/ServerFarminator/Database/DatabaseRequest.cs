...
namespace ServerFarminator.Database
{
    class DatabaseRequest
    {
        ...
        private string GetTasksForUser(string username)
        {
            ...
            cmd.CommandText = "Select Id, Descriere From Task Where MuncitorId = (SELECT Id From Client where Username = '"+ username + "') AND Stare = 1";
        ...
        {
            cmd.CommandText = "Select Id, Descriere From Task Where MuncitorId is NULL AND Stare = 1";
            cmd.Connection = sqlConnection1;
        ...
        private string GetLotType()
        {
            ...
            cmd.CommandText = "Select * From ParceleTypes";
            cmd.Connection = sqlConnection1;
